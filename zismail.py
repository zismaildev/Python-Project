...
while True:
    ...
    # คำนวณค่าใช้จ่าย, ค่าเทอม, เงินลงทุน, ซื้อของให่้ตัวเอง,เงินที่ใช้ไม่ได้, และเงินที่เหลือสำหรับใช้ได้
    ...
    print(f"ค่าเทอม (Education Fee): {educationfee:.2f} บาท")
